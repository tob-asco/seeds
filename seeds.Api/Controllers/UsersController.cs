...
public class UsersController : ControllerBase
{
    ...
    [HttpGet("{username}")]
    public async Task<ActionResult<UserDtoApi>> GetUserByUsername(string username)
    {
        ...
        var userDto = mapper.Map<UserDtoApi>(user);
    ...
    [HttpPost]
    public async Task<ActionResult<User>> PostUser(UserDtoApi userDto)
    {
        if (_context.User == null)
